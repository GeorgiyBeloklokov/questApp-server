...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '6515434', description: 'User password' }),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: false,
    }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'true', description: 'Is banned' }),
    (0, sequelize_typescript_1.Column)({
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Code conduct', description: 'Reason' }),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: true,
    }),
